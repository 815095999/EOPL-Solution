  ...
  (lambda (exp tenv)
    (cases expression exp
      ...
      (qualified-var-exp (module-var)
                         (loopup-qualified-var-in-tenv (module-var->m-name module-var)
                                                       (module-var->var module-var) tenv))
      )))
...
(define value-of
  (lambda (exp env)
    (cases expression exp
      ...
      (qualified-var-exp (module-var)
                         (loopup-qualified-var-in-env (module-var->m-name module-var)
                                                      (module-var->var module-var) env))
      )))
