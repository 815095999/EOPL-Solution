      ...
      (list-exp (exps)
                (if (null? exps)
                    ...
                    (value-of/k (car exps) env (list-cont '()
                                                          ...
                                                          cont))))
      (letcc-exp (var exp)
                 (value-of/k exp (extend-env var cont env) cont))
      (throw-exp (exp1 exp2)
...
(run "letcc x in throw 5 to x")
(run "let x = list(letcc y in list(3,throw 5 to y)) in x")
(run "let x = list(letcc y in list(3,5)) in x")