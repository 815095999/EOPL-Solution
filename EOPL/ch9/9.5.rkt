...
(define apply-method
  (lambda (m self args)
    (cases method m
      (a-method (vars body host-class-name field-names)
                (value-of body
                          (extend-env vars (map newref args)
                                      (extend-env-with-self-and-super
                                       self (class->super-name (lookup-class host-class-name))
...
(define method-decls->method-env
  (lambda (m-decls host-class-name field-names)
    (map
     (lambda (m-decl)
