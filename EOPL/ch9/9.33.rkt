      ...
      (instanceof-exp (exp class-name)
                      (let ([obj-type (type-of exp tenv)])
                        (if (class-type? obj-type)
                            (if (assoc class-name the-static-class-tenv)
                                (bool-type)
                                (eopl:error 'instance-exp "bad class name to instanceof ~a in ~a" class-name exp))
                ...
                (let ([obj-type (type-of exp tenv)])
                  (if (class-type? obj-type)
                      (if (assoc class-name the-static-class-tenv)
                          ...
                          (eopl:error 'cast-exp "bad class name to instanceof ~a in ~a" class-name exp))
